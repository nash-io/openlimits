...
impl NashWebsocket {
    pub async fn public(client_id: u64, sandbox: bool, timeout: Duration, sign_states_loop_interval: Option<u64>) -> Self {
    ...
    pub async fn with_credential(
        ...
        NashWebsocket {
            client: Client::from_key_data(secret, session, None, client_id, environment, timeout, sign_states_loop_interval)
                .await
                .expect("Couldn't create Client."),
        }
    }
